...
function PlaceableRealBees.registerFunctions(placeableType)
	SpecializationUtil.registerFunction(placeableType, "getBeehiveInfluenceFactor", PlaceableRealBees.getBeehiveInfluenceFactor)
	SpecializationUtil.registerFunction(placeableType, "updateBeehiveState", PlaceableRealBees.updateBeehiveState)
	SpecializationUtil.registerFunction(placeableType, "getHoneyAmountToSpawn", PlaceableRealBees.getHoneyAmountToSpawn)
end

function PlaceableRealBees.registerOverwrittenFunctions(placeableType)
	SpecializationUtil.registerOverwrittenFunction(placeableType, "updateInfo", PlaceableRealBees.updateInfo)
end

function PlaceableRealBees.registerEventListeners(placeableType)
	SpecializationUtil.registerEventListener(placeableType, "onLoad", PlaceableRealBees)
	SpecializationUtil.registerEventListener(placeableType, "onDelete", PlaceableRealBees)
	SpecializationUtil.registerEventListener(placeableType, "onFinalizePlacement", PlaceableRealBees)
end

function PlaceableRealBees.registerXMLPaths(schema, basePath)
...
function PlaceableRealBees:onLoad(savegame)
...
function PlaceableRealBees:onDelete()
	local spec = self.spec_beehive
...
function PlaceableRealBees:onFinalizePlacement()
	local spec = self.spec_beehive
...
function PlaceableRealBees:getBeehiveInfluenceFactor(wx, wz)
	local spec = self.spec_beehive
...
function PlaceableRealBees:updateBeehiveState()
	local spec = self.spec_beehive
...
function PlaceableRealBees:getHoneyAmountToSpawn()
	local spec = self.spec_beehive
...
function PlaceableRealBees:updateInfo(superFunc, infoTable)
	local spec = self.spec_beehive
